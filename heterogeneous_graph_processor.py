...
#json_folder = "./LTspice_examples/json_files"
...
COMPONENT_CATEGORIES = {
    ...
    'passive': [
        ...
        'Ind', 'Inductor',  # 电感
        'Res', 'Resistor',  # 电阻
        'CoupledInd', 'TransLine',
        'UniformRC', 'LossyTransLine',
        'CoupledMultiLine'
    ],
...
def process_all_circuits():
    ...
    with open("./data/LTspice_examples_4node_heterogeneous.pkl", 'wb') as f:
        pickle.dump(graph_list, f)
    with open("./data/LTspice_examples_4node_heterogeneous_label_mapping.pkl", 'wb') as f:
    ...
    # ltspcie_demos保存数据
    os.makedirs("./data", exist_ok=True)
    with open("./data/LTspice_demos_4node_heterogeneous.pkl", 'wb') as f:
        pickle.dump(graph_list, f)
    with open("./data/LTspice_demos_4node_heterogeneous_label_mapping.pkl", 'wb') as f:
        pickle.dump(label_mapping, f)
    """

    # kicad_github保存数据
    os.makedirs("./data", exist_ok=True)
    with open("./data/KiCad_github_4node_heterogeneous.pkl", 'wb') as f:
        pickle.dump(graph_list, f)
...
def convert_to_pyg_format():
    ...
    with open("./data/LTspice_examples_4node_heterogeneous.pkl", 'rb') as f:
        dataset = pickle.load(f)
    with open("./data/LTspice_examples_4node_heterogeneous_label_mapping.pkl", 'rb') as f:
        mapping = pickle.load(f)
    """
    """
    # ltspice_demos加载数据
    with open("./data/LTspice_demos_4node_heterogeneous.pkl", 'rb') as f:
        dataset = pickle.load(f)
    with open("./data/LTspice_demos_4node_heterogeneous_label_mapping.pkl", 'rb') as f:
        mapping = pickle.load(f)
    """


    # kicad_github加载数据
    with open("./data/KiCad_github_4node_heterogeneous.pkl", 'rb') as f:
        dataset = pickle.load(f)
    ...
    # ltspice_demos保存
    #torch.save(data, './data/LTspice_demos_4node_heterogeneous.pt')
...
def validate_dataset():
    ...
    try:
        ...
        try:
            ...
            """
            data = torch.load(
                './data/LTspice_demos_4node_heterogeneous.pt',
                weights_only=True
            )
            """
